    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body" >
			...
			<form action="./pfs_compare.jsp" method="post" name="wfrm">
				...
				<table class="table table-bordered" >
					...
					<tr class="top">
						...
						<td class="cell">
							...
							<option value="서울특별시 서초구 강남대로6길 66-4 (양재동)">서울특별시 서초구 강남대로6길 66-4 (양재동)</option>
							</select>
						</td>
						<td class="cell">
							<select class="form-control" id="address2" name="address2" >
							<option value="none">매물 선택</option>
							<option value="서울특별시 서초구 동산로 73 (양재동)">서울특별시 서초구 동산로 73 (양재동)</option>
							</select>
						</td>
						<td class="cell">
							<select class="form-control" id="address3" name="address3" >
							<option value="none">매물 선택</option>
							<option value="서울특별시 서초구 동산로 2 (양재동)">서울특별시 서초구 동산로 2 (양재동)</option>
							</select>
						</td>
					</tr>
